...
dirList = glob.glob("/home/usuario/Escritorio/SMC/2 term/Music Information Retrieval/Classical Composer Identification/code_6/data_noise/bach/*.wav")
fft = FFT()
...
dirList = glob.glob("/home/usuario/Escritorio/SMC/2 term/Music Information Retrieval/Classical Composer Identification/code_6/data_noise/beethoven/*.wav")
...
dirList = glob.glob("/home/usuario/Escritorio/SMC/2 term/Music Information Retrieval/Classical Composer Identification/code_6/data_noise/chopin/*.wav")
...
for audio_file in dirList:
	...
	f.write('\n')
# 4
dirList = glob.glob("/home/usuario/Escritorio/SMC/2 term/Music Information Retrieval/Classical Composer Identification/code_6/data_noise/haydn/*.wav")
...
for audio_file in dirList:
	...
	f.write('\n')
# 5
dirList = glob.glob("/home/usuario/Escritorio/SMC/2 term/Music Information Retrieval/Classical Composer Identification/code_6/data_noise/liszt/*.wav")
...
for audio_file in dirList:
	...
	f.write('\n')
# 6
dirList = glob.glob("/home/usuario/Escritorio/SMC/2 term/Music Information Retrieval/Classical Composer Identification/code_6/data_noise/mendelssohn/*.wav")
...
for audio_file in dirList:
	...
	f.write('\n')
# 7
dirList = glob.glob("/home/usuario/Escritorio/SMC/2 term/Music Information Retrieval/Classical Composer Identification/code_6/data_noise/mozart/*.wav")
...
for audio_file in dirList:
	...
	f.write('\n')
# 8
dirList = glob.glob("/home/usuario/Escritorio/SMC/2 term/Music Information Retrieval/Classical Composer Identification/code_6/data_noise/vivaldi/*.wav")
